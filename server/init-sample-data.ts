import { db } from "./db";
import { users, attendance, leaveRequests, announcements } from "../shared/schema";
...
export async function initializeSampleData() {
  try {
    ...
    const insertedUsers = await db.insert(users).values(sampleEmployees).returning();
    ...
    const announcementsData = [
      ...
      },
      {
        ...
        createdBy: insertedUsers[1].id, // HR Manager
        priority: "medium",
        targetAudience: "all",
